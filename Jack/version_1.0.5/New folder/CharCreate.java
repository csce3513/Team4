 ...
 //   Menu f;
    ...
    private void initComponents() {
        ...
        F_button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                F_buttonMousePressed(evt);
            }
        });
        getContentPane().add(F_button);
        F_button.setBounds(450, 90, 80, 40);

        Elements.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Fire", "Water", "Earth", "Air" }));
        ...
        Elements.setBounds(370, 190, 110, 20);
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/element.jpg"))); // NOI18N
        jLabel2.setText("Element");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(460, 40, 130, 60);
...
private void M_buttonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_M_buttonMousePressed
        setGender("Male");
}//GEN-LAST:event_M_buttonMousePressed

private void F_buttonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_F_buttonMousePressed
        setGender("Female");
}//GEN-LAST:event_F_buttonMousePressed
