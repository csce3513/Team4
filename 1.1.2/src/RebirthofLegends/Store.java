...
public class Store extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        display.setFont(new java.awt.Font("Kingthings Xander", 1, 24)); // NOI18N
        display.setForeground(new java.awt.Color(255, 255, 255));
        display.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        display.setText(h.getCrystals()+" Crystals");
        getContentPane().add(display);
        display.setBounds(240, 300, 330, 40);
        ...
        UpgradeLabel.setBounds(210, 60, 190, 16);
        ...
        BuyHPLabel.setBounds(210, 140, 190, 16);
        ...
        HealLabel.setBounds(210, 210, 190, 16);
...
// Heal button:
    if(h.maxHealth == h.health){
        ...
        h.heal();
        h.takemymoney(1);
        String output = "You have been healed back to "+h.getHealth()+" health! ";
        JOptionPane.showMessageDialog(null, output);
    } else {
...
// Buy HP button:
    if (h.getCrystals() >= 10) {
        h.takemymoney(10);
        h.incMaxHP();
        String output = "You now have " + h.getMaxHealth() + " HP";
        JOptionPane.showMessageDialog(null, output);
    } else {
        String output = "You aint got no dough =( ";
        JOptionPane.showMessageDialog(null, output);
...
// Weapon Upgrade Button:
    if (h.getCrystals() >= h.weapon.cToUpg()) {
        ...
        h.weapon.upgrade();
        String output = "Your weapon now has " + h.weapon.getWpatk() + " Attack";
        JOptionPane.showMessageDialog(null, output);
    } else {
        String output = "You aint got no dough =( ";
        JOptionPane.showMessageDialog(null, output);
